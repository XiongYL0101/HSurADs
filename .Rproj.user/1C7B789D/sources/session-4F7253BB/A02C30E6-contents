#' HpSurADs
#'
#' HpSurADs is used for predicting the survival rate of lung adenocarcinoma patients
#' @param x a data.frame containing gene expression matrix of lung adenocarcinoma patients,while each column represents a patient, and each row represents a gene
#'
#' @import rms
#' @import pec
#' @import survival
